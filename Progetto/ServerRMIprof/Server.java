...
public class Server implements ServerInt {
  ...
  public static void main(String args[]) {
		try {
			...
			System.setProperty("java.rmi.server.codebase","/mnt/d/Repositories/GitHub/FREDwiz/PCAD/PCAD/Progetto/ServerRMIprof"); //It should be before Server obj = new Server(); 
